...
export default function PricingModal({ isOpen, onClose, serviceId, actionType = "purchase", forcePlanId = "", lockSelection = false, hideFreePlans = false }) {
  ...
  return (
    ...
    >
      ...
      >
        <button
          onClick={onClose}
          className="absolute top-3 right-3 p-1.5 rounded-full text-gray-600 "
            ...
            return (
              ...
              >
                ...
                <div className="flex-1 min-w-0">
                  <p className="text-sm text-[#373737] font-medium mb-0.5 leading-tight">
                    {plan.title}
                  </p>
                  <div className="flex items-baseline gap-1">
                    ...
                    <span className="text-3xl font-bold text-[#004C48] ">
                      / {plan.duration} days
                    </span>
                  </div>
                </div>
